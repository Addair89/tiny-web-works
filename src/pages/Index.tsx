...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      <section id="pricing" className="px-6 py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                {index < 3 && <div className="hidden lg:block absolute top-10 -right-4 w-8 h-0.5 bg-gradient-to-r from-blue-300 to-indigo-300"></div>}
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="contact" className="px-6 py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
            ...
            <CardContent className="pt-0">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <Label htmlFor="name" className="text-slate-200 font-medium text-lg">Name</Label>
                    <Input 
                      id="name" 
                      type="text" 
                      value={formData.name} 
                  ...
                  <div>
                    <Label htmlFor="email" className="text-slate-200 font-medium text-lg">Email</Label>
                    <Input 
                      id="email" 
                      type="email" 
                ...
                <div>
                  <Label htmlFor="message" className="text-slate-200 font-medium text-lg">Message</Label>
                  <Textarea 
                    id="message" 
